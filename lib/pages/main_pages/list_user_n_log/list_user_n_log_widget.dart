...
class _ListUserNLogWidgetState extends State<ListUserNLogWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.investData = await queryInvestmentDataRecordOnce(
        queryBuilder: (investmentDataRecord) =>
            investmentDataRecord.orderBy('duration', descending: true),
      );
      _model.logList = _model.logDoc!.toList().cast<LogRecord>();
      _model.userDetail = _model.userData!.toList().cast<UsersRecord>();
      _model.investmentList =
          _model.investData!.toList().cast<InvestmentDataRecord>();
      setState(() {});
    });
                                                                ...
                                                                onChanged:
                                                                  ...
                                                                  setState(() =>
                                                                      _model.choiceChipsValue =
                                                                          val?.firstOrNull);
                                                                  logFirebaseEvent(
                                                                      'LIST_USER_N_LOG_ChoiceChips_bup8q31b_ON_');
                                                        ...
                                                        child: Container(
                                                          ...
                                                          child: TextFormField(
                                                            ...
                                                            onFieldSubmitted:
                                                                (_) async {
                                                              logFirebaseEvent(
                                                                  'LIST_USER_N_LOG_TextField_neka7cvq_ON_TE');
                                                              safeSetState(() {
                                                ...
                                                child: Container(
                                                  ...
                                                  child: TextFormField(
                                                    ...
                                                    onFieldSubmitted:
                                                        (_) async {
                                                      logFirebaseEvent(
                                                          'LIST_USER_N_LOG_TextField_htl3khoi_ON_TE');
                                                      safeSetState(() {
                                                                  ...
                                                                  builder:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      onTap:
                                                                          () async {
                                                                        logFirebaseEvent(
                                                                            'LIST_USER_N_LOG_Column_tvr66ayl_ON_TAP');
                                                                        await showDialog(
                                                                          context:
                                                                              context,
                                                                          builder:
