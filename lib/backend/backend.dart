...
import 'schema/investment_data_record.dart';
...
export 'schema/investment_data_record.dart';
...
/// Functions to query InvestmentDataRecords (as a Stream and as a Future).
Future<int> queryInvestmentDataRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
...
Stream<List<InvestmentDataRecord>> queryInvestmentDataRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      InvestmentDataRecord.collection,
      InvestmentDataRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<InvestmentDataRecord>> queryInvestmentDataRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
